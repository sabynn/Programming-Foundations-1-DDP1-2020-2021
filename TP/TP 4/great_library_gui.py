...
class GreatLibrary():
    ...
    def add_buku(self):
        if self.b_rak.get() and self.b_nama.get() and self.b_tahun.get() and self.b_penulis.get() \
                and self.b_penerbit.get() and self.b_jenis.get() and self.b_extra.get():
...
tup_perintah = ("ADD BUKU", "ADD RAK", "SEARCH", "LIST", "EXIT")
...
def main():
    ...
    # memunculkan GUI form sesuai input perintah
    if len(lst_perintah) >= 2 and " ".join([lst_perintah[0], lst_perintah[1]]) in tup_perintah:
        if len(lst_perintah) == 2 and lst_perintah[0] == "ADD" and lst_perintah[1] == "RAK":
            library.form_rak()
        elif len(lst_perintah) == 2 and lst_perintah[0] == "ADD" and lst_perintah[1] == "BUKU":
            library.form_buku()
        else:
            print("Perintah tidak valid")
    elif len(lst_perintah) >= 1 and lst_perintah[0] in tup_perintah:
        if len(lst_perintah) == 1 and lst_perintah[0] == "SEARCH":
            library.form_search()
        elif len(lst_perintah) == 1 and lst_perintah[0] == "LIST":
            # mengecek apabila belum ada buku di rak
            if not library.bookshelf():
        ...
        elif len(lst_perintah) == 1 and lst_perintah[0] == "EXIT":
